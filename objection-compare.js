/* Compi V1.2 (Events only once) */
setting = 'char'; /* 'char'|'word' */

/*Control flow based on url*/
currentUrl = window.location.href;
regex1 = /a3\.flit\.to\/#\/arcade\/arcade-objection/;
if (regex1.test(currentUrl)) {
main();
} else {
if (window.confirm(`Go to arcade-objection page?`)) {
    window.location.href='https://a3.flit.to/#/arcade/arcade-objection';
};
}
